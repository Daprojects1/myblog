...
const RegisterPage = () => {
  ...
  const formik = useFormik({
    ...
    validationSchema: Yup.object({
      ...
      email: Yup.string().required('Please enter your email').matches(
  ...
  const { handleBlur, handleChange, values, errors, touched, handleSubmit } = formik
  ...
  const handleLogin = (e) => {
    ...
    return (
      ...
      <p>Already have an account ? <span className="createAccLink" onClick={()=>handleReRoute('/login')}>Sign in</span></p>
      </div>
     </form>
      );
}
